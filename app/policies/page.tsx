...
export default function PoliciesPage() {
  ...
  return (
    <main className="policies-page">
      <header className="product-page-header"><Link href="/">← Home</Link><BrandLogo className="checkout-wordmark" priority /><a href={whatsappHref(policyMessage)} target="_blank" rel="noreferrer">Questions?</a></header>
      <div className="policies-layout">
        ...
        <article>
          <section id="shipping"><span>01</span><h2>Shipping</h2><p>We deliver across India where the destination PIN code is serviceable. Shipping is calculated at checkout from the packed weight of your order and your delivery destination. The amount shown is a checkout estimate based on our current rate card; courier availability, PIN-code restrictions, capacity, holidays and weather can affect dispatch and delivery timing. Orders are normally prepared for dispatch within 2–4 working days.</p><p>Some remote, unserviceable or higher-weight destinations need a manual WhatsApp quote before payment. International delivery is also a manual quote before payment. We do not guarantee a courier price until a courier booking or direct courier integration is in place; tracking details are shared after the booking is complete.</p></section>
