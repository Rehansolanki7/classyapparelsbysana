...
async function main() {
  ...
  try {
    ...
    const migrations = ["0000_public_photon", "0001_release_hardening", "0002_manual_delivery", "0003_customer_experience", "0004_truthful_shipping_privacy", "0005_shipping_seed_fix", "0006_refund_restock", "0007_homepage_editor", "0008_managed_categories", "0009_admin_mfa", "0010_homepage_categories_and_product_sizes", "0011_product_order"];
